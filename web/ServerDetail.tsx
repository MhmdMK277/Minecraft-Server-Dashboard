...
/** Management surface: who is on, plainly. Whitelist management lands here. */
function Players({ s }: { s: ServerStatus }) {
    ...
    >
      {online.length > 0 ? (
        ...
        <p className="prose-line text-[12px] text-faint">
          No one is online{slpCount != null && slpCount > 0 ? `, though the ping reports ${slpCount}` : ''}.
        </p>
      )}
    </Section>
  )
